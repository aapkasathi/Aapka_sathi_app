          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "In today’s world, digital skills aren’t optional—they’re essential. Yet, many vendors lack access or knowledge to use digital tools effectively.\n\nAapka Sathi’s Digital Empowerment service ensures every vendor can confidently use smartphones, apps, UPI, QR codes, and social media to grow their business, track finances, and connect with customers.", //
                  style: TextStyle(
                    fontSize: 14,
                    height: 1.5,
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      "Sunil, a momo vendor in Gwalior, didn’t know how to use UPI or QR payments. With Aapka Sathi’s help, he set up a QR code, joined WhatsApp groups, and began posting updates. His customer base expanded by 35%.", //
                      style: TextStyle(
                        fontSize: 14,
