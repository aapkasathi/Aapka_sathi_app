          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "Getting started as a street vendor can be overwhelming—especially when faced with unfamiliar paperwork, online forms, and unclear processes.\n\nAapka Sarthi’s Vendor Support service ensures that every vendor receives complete, personalized assistance from day one. From registration and documentation to technical help and field guidance, we make sure no vendor is left behind.", 
                  style: TextStyle(
                    fontSize: 14,
                    height: 1.5,
