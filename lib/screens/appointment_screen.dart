  ...
  Future<void> _handleBooking() async {
    ...
    if (_selectedDateIndex == -1 ||
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
            content: Text("Please select Date, Time, Service and Mode")),
      );
      return;
    }
    ...
    // Selected date calculate karein
    DateTime selectedDate = DateTime(
        _currentMonth.year, _currentMonth.month, _selectedDateIndex + 1);

    // 2. Service call karein
    bool success = await RegistrationService().bookAppointment(
      date: selectedDate,
      timeSlot: _timeSlots[_selectedTimeIndex],
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    Navigator.pushNamedAndRemoveUntil(context, '/dashboard',(route)=>false);  // Appointment screen band karein
                  },
          ...
          children: [
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color:
                                  isSelected ? Colors.orange : _unselectedColor,
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: _isBooking ? const CircularProgressIndicator(color: Colors.white): const Text("Submit", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
  ...
  Widget _buildRadioOption(String label) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            color: _unselectedColor, borderRadius: BorderRadius.circular(20)),
        child: Row(
          children: [
            Container(
              height: 20,
