              ...
              Expanded(
                child: ListView(
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        Container(
                          ...
                          child: CircleAvatar(
                            radius:
                                40, // Adjusted radius to fit 40% width better if screen is small
                        ...
                        Text(
                          ...
                          style: const TextStyle(
                            fontSize:
                                18, // Slightly reduced font to fit 40% width
                    ...
                    // ----------------------------------------
                    _buildSectionHeader(
                        "Licenses & Certtificates"), // Shortened title for narrow width
                    _buildMenuItem(context, "Licenses", Icons.card_membership,
                        '/licenses'),
                    _buildMenuItem(context, "Certificates",
                    ...
                    _buildMenuItem(context, "Policies", Icons.policy_outlined,
                        '/policies'),
                    _buildMenuItem(context, "Licenses Info", Icons.info_outline,
                        '/licenses_info'),
                    ...
                    _buildMenuItem(context, "Subscription Form",
                        Icons.autorenew, '/subscription_form'),
                    _buildMenuItem(context, "Payment Receipt",
                        Icons.receipt_long_outlined, '/payment_receipt'),
                    ...
                    _buildMenuItem(
                        context, "Help & Support", Icons.help_outline, '/help'),
                    _buildMenuItem(context, "Setting", Icons.settings_outlined,
                        '/settings'),
                    ...
                    InkWell(
                      onTap: () {
                        onClose();
                        AuthController.loggedInUserId = null;
