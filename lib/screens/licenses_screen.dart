...
Future<void> _fetchDocs() async {
  final docs = await RegistrationService().getUploadedDocs("license"); // 👈 Certificates wali screen par "certificate" likhna
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      //           final url = await service.uploadFile(file: f,
                      //           userId : userId,
                      //           folder: "licenses",);
                      //           if(url!=null){
    ...
    for (var file in _selectedFiles) {
      ...
      if (file.size <= 10485760) {
        await service.uploadAndSaveDoc(
          file: File(file.path!),
          fileName: file.name,
          docType: "license", // 👈 Certificates wali file mein yahan "certificate" likhein
          fileSize: file.size,
            ...
            child: SafeArea(
              ...
              child: Padding(
                padding: const EdgeInsets.only(
                    bottom: 20.0), // Extra padding from bottom edge
                child: SizedBox(
                  width: double.infinity,
                  height: 55,
                  child: ElevatedButton(
