...
class _BankDetailsScreenState extends State<BankDetailsScreen> {
  ...
  Future<void> _pickFile() async {
    ...
    if (result != null) {
      setState(() {
        _passbookPhotoName = result.files.single.name;
      });
    }
  }
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildInputField(hint: "Enter Account Number"),
                          _buildLabel("IFSC Code *"),
                          _buildInputField(hint: "Enter IFSC Code"),
                          _buildLabel("Account Holder Name *"),
                          _buildInputField(hint: "Enter Holder Name"),
